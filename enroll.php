...
$course=$_POST['course'];
$sem=$_POST['sem'];
$ret=mysqli_query($con,"insert into courseenrolls(studentRegno,session,department,semester,course) values('$studentregno','$session','$dept','$sem','$course')");
if($ret)
{
...
{ ?>
 ...
 <div class="form-group">
    <label for="studentregno">Student Roll No   </label>
